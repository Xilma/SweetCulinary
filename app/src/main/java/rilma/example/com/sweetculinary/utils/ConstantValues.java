...
public class ConstantValues {
    public static final String JSON_RESULT_EXTRA = "json_result";
    ...
    public static int[] unitImages = {
            ...
            rilma.example.com.sweetculinary.R.drawable.ic_teaspoon,
    ...
    public static int[] recipeImages = {
            ...
            rilma.example.com.sweetculinary.R.drawable.yellow_cake,
            rilma.example.com.sweetculinary.R.drawable.cheese_cake
    };
